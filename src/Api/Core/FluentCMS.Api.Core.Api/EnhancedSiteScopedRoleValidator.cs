...
internal class EnhancedSiteScopedRoleValidator(ISiteRepository siteRepository, IRoleRepository roleRepository, ILogger<EnhancedSiteScopedRoleValidator> logger, IdentityErrorDescriber? errors = null) : IRoleValidator<Role>
{
