...
{
    Task<Page> Create(string title, Guid siteId, Guid? parentId, string? path = null, int? order = null);
    Task ValidateEdit(Page page);
}

internal class PageService(IPageRepository _repository) : IPageService
{
