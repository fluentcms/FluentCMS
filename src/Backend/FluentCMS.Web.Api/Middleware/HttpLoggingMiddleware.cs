...
//    public async Task Invoke(HttpContext context, IHttpLogService httpLogService, ISetupService setupService)
//    {
//        if (!_httpLogConfig.Enable || !await setupService.IsInitialized())
//        {
//            await _next(context);
//            return;
//        }
