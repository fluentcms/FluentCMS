...
{
    Task<HttpResponseMessage> DownloadGetResponseMessageByIdAsync(Guid? id, CancellationToken cancellationToken = default);
    Task<HttpResponseMessage> DownloadGetResponseMessageAsync(string? url, CancellationToken cancellationToken = default);
}

public partial class FilesClient
{
    public async Task<HttpResponseMessage> DownloadGetResponseMessageByIdAsync(Guid? id, CancellationToken cancellationToken = default)
    {
