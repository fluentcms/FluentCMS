...
public partial class ContentUpdatePlugin
{
    ...
    {
        return FieldTypes.All[fieldModel.Type].FormComponents.Where(x => string.IsNullOrEmpty(fieldModel.FormViewComponent) ? true : x.Name == fieldModel.FormViewComponent).FirstOrDefault()?.Type ??
