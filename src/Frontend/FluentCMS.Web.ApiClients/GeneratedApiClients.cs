...
namespace FluentCMS.Web.ApiClients
{
    ...
    public partial interface IPageClient : IApiClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiClientException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PageDetailResponseListIApiResult> GetHierarchyBySiteIdAsync(System.Guid? siteId);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiClientException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PageDetailResponseListIApiResult> GetHierarchyBySiteIdAsync(System.Guid? siteId, System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiClientException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PageDetailResponseListIApiResult> GetHierarchyBySiteIdAsync(System.Guid? siteId)
        {
            return GetHierarchyBySiteIdAsync(siteId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiClientException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PageDetailResponseListIApiResult> GetHierarchyBySiteIdAsync(System.Guid? siteId, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/Page/GetHierarchyBySiteId"
                    urlBuilder_.Append("api/Page/GetHierarchyBySiteId");
                    urlBuilder_.Append('?');
                    if (siteId != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("SiteId")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(siteId, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PageDetailResponseListIApiResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiClientException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.1.0.0 (NJsonSchema v11.0.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PageDetailResponseListIApiResult
    {
