...
internal sealed class DatabaseMarkerMappingBuilder(IServiceCollection services) : IDatabaseMarkerMappingBuilder, IDatabaseManagerMappingBuilder
{
    ...
    /// </summary>
    public IDatabaseManagerMappingBuilder For<TLibraryMarker>() where TLibraryMarker : IDatabaseScopeMarker
    {
        _isDefault = false;
    ...
    /// </summary>
    public IDatabaseManagerMappingBuilder RegisterProvider(string providerName, string connectionString, Func<string, IServiceProvider, IDatabaseManager> factory)
    {
