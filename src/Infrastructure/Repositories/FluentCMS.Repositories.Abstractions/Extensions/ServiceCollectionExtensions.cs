...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddDatabaseManager(this IServiceCollection services, Action<IDatabaseMarkerMappingBuilder> configureMapping)
    {
        ...
        var builder = new DatabaseMarkerMappingBuilder(services);
        ...
        if (!builder.HasDefaultConfiguration)
        {
            throw new InvalidOperationException(
                "A default database provider must be configured. Call Default() and chain with a provider method (e.g., UseSqlServer()).");
        }
