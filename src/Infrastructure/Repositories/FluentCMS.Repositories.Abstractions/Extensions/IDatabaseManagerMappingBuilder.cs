...
/// </summary>
public interface IDatabaseManagerMappingBuilder
{
    /// <summary>
    ...
    IDatabaseManagerMappingBuilder RegisterProvider(string providerName, string connectionString, Func<string, IServiceProvider, IDatabaseManager> factory);
}
