...
/// </summary>
public interface IDatabaseMarkerMappingBuilder
{
    /// <summary>
    ...
    IDatabaseManagerMappingBuilder Default();
    ...
    IDatabaseManagerMappingBuilder For<TLibraryMarker>() where TLibraryMarker : IDatabaseScopeMarker;
}
