...
{
    public async Task<File?> GetBySlug(string slug, CancellationToken cancellationToken)
    {
    ...
    public async Task<File?> Delete(string slug, CancellationToken cancellationToken)
    {
